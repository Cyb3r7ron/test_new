...
import 'package:test_new/Videos/medeb_two/akal_two.dart';
import 'package:video_player/video_player.dart';

class AkalThree extends StatefulWidget {
  const AkalThree({Key? key}) : super(key: key);

  @override
  _AkalThreeState createState() => _AkalThreeState();
}

class _AkalThreeState extends State<AkalThree> {
