...
class AkalOne extends StatefulWidget {
  const AkalOne({Key? key}) : super(key: key);

  @override
  _AkalOneState createState() => _AkalOneState();
}

class _AkalOneState extends State<AkalOne> {
