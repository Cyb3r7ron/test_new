...
class AutoThree extends StatefulWidget {
  const AutoThree({Key? key}) : super(key: key);

  @override
  _AutoThreeState createState() => _AutoThreeState();
}

class _AutoThreeState extends State<AutoThree> {
  ...
  loadVideoPlayer() {
    controller = VideoPlayerController.asset(
        'assets/videos/medeb_two_auto/third vid.mp4');
