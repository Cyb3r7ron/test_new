...
class MotorThree extends StatefulWidget {
  const MotorThree({Key? key}) : super(key: key);

  @override
  _MotorThreeState createState() => _MotorThreeState();
}

class _MotorThreeState extends State<MotorThree> {
  ...
  loadVideoPlayer() {
    controller = VideoPlayerController.asset(
        'assets/videos/medeb_one_motor/third vid.mp4');
