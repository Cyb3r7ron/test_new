...
import 'package:test_new/Videos/medeb_five/automo_three.dart';
import 'package:video_player/video_player.dart';

class AutomoTwo extends StatefulWidget {
  const AutomoTwo({Key? key}) : super(key: key);

  @override
  _AutomoTwoState createState() => _AutomoTwoState();
}

class _AutomoTwoState extends State<AutomoTwo> {
