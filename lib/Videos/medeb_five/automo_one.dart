...
class AutomoOne extends StatefulWidget {
  const AutomoOne({Key? key}) : super(key: key);

  @override
  _AutomoOneState createState() => _AutomoOneState();
}

class _AutomoOneState extends State<AutomoOne> {
