...
import 'package:test_new/Videos/medeb_five/automo_two.dart';
import 'package:video_player/video_player.dart';

class AutomoThree extends StatefulWidget {
  const AutomoThree({Key? key}) : super(key: key);

  @override
  _AutomoThreeState createState() => _AutomoThreeState();
}

class _AutomoThreeState extends State<AutomoThree> {
  ...
  loadVideoPlayer() {
    controller = VideoPlayerController.asset(
        'assets/videos/medeb_five_auto/second vid_Trim.mp4');
